...
- [x] Every resource and every control re-verified live in a single pass against both clouds, not just at the time each change was made — see [Final Verification](#final-verification)
